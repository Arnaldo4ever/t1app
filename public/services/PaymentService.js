...
class PaymentService {
  constructor() {
    this.tokenst1 = {
      ...
      test: {
        access_token:
          "58d016d2b17e6ebacf19fe85e804243d06f083bc810b2ff9c0905ca44e697f0ded9ccfd08fbd86dc" 
...
// declaramos de la siguiente manera el token, para que sea más fácil cambiarlo dependiendo del ambiente
    this.t1Url = "https://api.t1.com/checkout"; 
 // declaramos la url en el constructor para poder accederla a lo largo de toda la clase
  }

  async createPaymentt1(name, price, unit, img) {  
// recibimos las props que le mandamos desde el PaymentController
    const url = `${this.t1Url}/preferences?access_token=${this.tokenst1.test.access_token}`; 
...
// nombre que viene de la prop que recibe del controller
        description: "Mesa Eterna Wengue",
 // descripción del producto
        picture_url: "https://texcomercial.com.co/cdn/shop/files/download_0d69170c-07cb-4987-bd54-1f1f15c74915_400x.jpg", 
...
// url a la que va a redireccionar si falla el pago
      ...
      notification_url: "https://t1-checkout.herokuapp.com/webhook", 
